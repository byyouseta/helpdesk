...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('template/assets/img/favicon/logo.png') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('template/assets/vendor/libs/toastr/toastr.min.css') }}">
  ...
  <body>
          ...
          <div class="app-brand demo">
            <a href="{{ route('home') }}" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="{{ asset('template/assets/img/favicon/LogoKemenkesIcon.png') }}" alt="Logo Kemenkes" width="50">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                  ...
                  <button type="button" class="btn rounded-pill btn-secondary btn-sm">
                    <span class="tf-icons bx bxs-coupon bx-tada bx-flip-horizontal"></span>&nbsp;<span class="badge bg-danger text-grey rounded-pill">4</span>
                  </button>
                </li>
    ...
    <script src="{{ asset('template/assets/vendor/libs/toastr/toastr.min.js') }}"></script>
